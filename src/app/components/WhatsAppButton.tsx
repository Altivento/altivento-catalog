...
export default function WhatsAppButton() {
  ...
  return (
    <button 
      ...
      className="no-print fixed bottom-20 right-6 bg-[#25D366] hover:bg-[#128C7E] text-white font-medium shadow-lg flex items-center justify-center transition-colors rounded-full w-12 h-12 md:w-auto md:h-auto md:rounded-md md:py-2 md:px-4"
